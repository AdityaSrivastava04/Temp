  ...
  return (
    <footer className="text-black py-8">
      <div className="container mx-auto px-8 lg:px-20">
        ...
        {/* Added Terms and Privacy links above the border */}
        <div className="flex justify-end mb-4">
          <div className="flex items-center space-x-4 text-sm text-[#8590AA]">
            <a 
              href="/terms" 
              className="hover:font-bold hover:text-black active:font-bold active:text-black"
            >
              Terms & Conditions
            </a>
            <span className="text-[#8590AA]">|</span>
            <a 
              href="/privacy" 
              className="hover:font-bold hover:text-black active:font-bold active:text-black"
            >
        ...
        <div className="border-t pt-6 flex flex-col md:flex-row items-center justify-between text-sm text-black">
          <p className="text-lg">&copy; 2024 NEBULYN. All rights Reserved</p>
          <div className="flex space-x-6 mt-3 md:mt-0 text-2xl">
            <a href="https://www.instagram.com/nebulyn.neb/" className="hover:font-bold">
              <FaInstagram />
            </a>
            <a href="https://www.linkedin.com/company/nebulyn/" className="hover:font-bold">
              <FaLinkedin />
            </a>
          </div>
        </div>
