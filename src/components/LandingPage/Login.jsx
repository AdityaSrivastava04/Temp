...
<div className="w-[45%] bg-gray-200 rounded-lg h-[85%] mt-3 overflow-hidden flex items-center justify-center">
  <img src={login} alt="Login" className="h-full object-cover rounded-lg" />
</div>
        </div>
      </div>
    </div>
