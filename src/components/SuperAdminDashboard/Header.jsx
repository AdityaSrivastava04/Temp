...
const Header = () => {
  ...
  const companyName = "Nebulyn"; // Fixed company name as requested
    ...
    <header className="bg-white border-b border-gray-200 flex items-center justify-between p-4">
      ...
      <div className="flex items-center px-3 py-1">
        ...
        <div className="relative">
          ...
          {open && (
            <div className="absolute right-0 mt-3 w-96 bg-white shadow-2xl border-gray-100 rounded-lg border p-4 z-50">
              {/* Header */}
