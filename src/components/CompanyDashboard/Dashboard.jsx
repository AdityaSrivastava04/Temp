...
import { CalendarIcon, Loader, AlertTriangle, ChevronRight, Eye, FileText } from "lucide-react";
...
const DUMMY_DATA = {
  ...
  company: {
    ...
    logo: "https://placehold.co/32x32/png", // You can use any placeholder image
  },
  applications: {
    recent: 28,
    byJobType: {
  ...
  timeSeriesData: Array.from({ length: 30 }, (_, i) => ({
    ...
    views: Math.floor(100 + Math.random() * 50),
    applications: Math.floor(5 + Math.random() * 10),
  })),
};
...
const Dashboard = () => {
  ...
  // Simulate data fetch with dummy data
  useEffect(() => {
    setLoading(true);
    setError(null);
