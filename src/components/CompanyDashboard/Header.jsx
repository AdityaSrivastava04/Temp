...
const DUMMY_COMPANY = {
  ...
  companyLogo: "https://placehold.co/32x32/png", // Placeholder logo, change if you want
};
...
const Header = () => {
  ...
  useEffect(() => {
    setCompanyName(DUMMY_COMPANY.companyName || "Company");
    setCompanyLogo(DUMMY_COMPANY.companyLogo || null);
  }, []);
